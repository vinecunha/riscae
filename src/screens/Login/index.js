...
export default function Login() {
  ...
  const handleEmailChange = (text) => {
    ...
    if (text.includes('@')) {
      ...
      // Só mostra sugestão se o usuário ainda não terminou de digitar o domínio exato
  ...
  return (
    <View style={styles.container}>
      ...
      {step === 'EMAIL' ? (
        ...
        <>
          <Text style={styles.subtitle}>Digite o código de 8 dígitos enviado para {email}</Text>
          <TextInput 
            style={styles.input} 
